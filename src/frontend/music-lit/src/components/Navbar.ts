    ...
    render() {
        return html`
            <nav>
                ...
                <a href="https://music.mariolopez.org/lit" target="_self" rel="alternate"><img src=${litLogo} alt="Lit" class="focused-icon" /></a>
                ...
                <a href="https://music.mariolopez.org/preact" target="_self" rel="alternate"><img src=${preactLogo} alt="Preact" /></a>
