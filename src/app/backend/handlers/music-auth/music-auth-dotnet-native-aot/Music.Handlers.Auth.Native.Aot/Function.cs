...
using Music.Handlers.Auth.Native.Aot.Handlers;
using System.Text.Json.Serialization;

namespace Music.Handlers.Auth.Native.Aot;

public class Function
{
    private static readonly AuthTokenHandler authTokenHandler = new();
    ...
    /// defined below will need the JsonSerializable updated. If the return type and event type are different from the
