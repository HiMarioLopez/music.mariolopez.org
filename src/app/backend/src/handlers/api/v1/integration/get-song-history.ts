...
>({ serviceName: 'get-song-history' }, async (event, context, utils) => {
  try {
    ...
    utils.logger.info('Successfully returned song history', {
    ...
    utils.logger.error('Error fetching music history', { error });
